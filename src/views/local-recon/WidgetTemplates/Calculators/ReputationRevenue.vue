    ...
    <div>
    	<div v-if="CalculatorStyle == 'Style1'">
          ...
          <div class="float-right text-center" :style="'width: 30%; height: 430px; padding-top: 55px; font-size: 24px; background-color: ' + widget.properties.result_background_color + '; color: ' + widget.properties.result_text_color + '; font-weight: bold;'">
              ...
              <h3 id="lr_calculated_ddr" style="line-height: 52px;">{{ widget.properties.calculated_ddr ? widget.properties.calculated_ddr : this.widget.properties.currency +' 367' }}</h3>

              <h3 style="line-height: 52px;">Monthly (MRR)</h3>
              <h3 id="lr_calculated_mrr" style="line-height: 52px;">{{ widget.properties.calculated_mrr ? widget.properties.calculated_mrr : this.widget.properties.currency +' 11,175' }}</h3>

              <h3 style="line-height: 52px;">Annualy (ARR)</h3>
              <h3 id="lr_calculated_arr" style="line-height: 52px;">{{ widget.properties.calculated_arr ? widget.properties.calculated_arr : this.widget.properties.currency +' 134,100' }}</h3>
              <!-- <h3>&nbsp;</h3> -->
          </div>
                ...
                >
                    <div class="p-2">
                		<div class="flex flex-row flex-wrap">
                			<div class="dashboard-box stats-box w-full px-2 md:w-1/3 lg:w-1/3 pt-6">
                				<div style="width: 220px; margin: auto; text-align: center;">
									       ...
									       <br />
									       <div style="color: #CCCCCC; margin-top: -50px;">Revenue</div>


                				</div>

                          <div style="padding-top: 60px; line-height: 26px;">
                            <div class="flex flex-row flex-wrap" style="font-size: 14px;">
                              <div class="w-full md:w-1/3 lg:w-1/3" style="text-align: center;">
                                Daily

                                <br />
                                <strong id="lr_calculated_ddr">{{ widget.properties.calculated_ddr ? widget.properties.calculated_ddr : this.widget.properties.currency +' 367' }}</strong>
                              ...
                              <div class="w-full md:w-1/3 lg:w-1/3" style="text-align: center;">
                                ...
                                <br />
                                <strong id="lr_calculated_mrr">{{ widget.properties.calculated_arr ? widget.properties.calculated_arr : this.widget.properties.currency +' 134,100' }}</strong>
                              ...
                              <div class="w-full md:w-1/3 lg:w-1/3" style="text-align: center;">
                                ...
                                <br />
                                <strong id="lr_calculated_arr">{{ widget.properties.calculated_mrr ? widget.properties.calculated_mrr : this.widget.properties.currency +' 11,175' }}</strong>
                          ...
                          <div class="w-full px-2 md:w-1/2 lg:w-1/2">
                            <div style="background: rgba(25, 35, 58, 0.05); padding: 20px;">
                              <div class="mb-3" :style="'color: ' + widget.properties.titles_color">Number of Local Business Clients: <strong>{{ widget.properties.number_of_local_business_clients }}</strong></div>
                      ...
                      max="999"
                          ...
                          <div class="w-full px-2 md:w-1/2 lg:w-1/2">
                            <div style="background: rgba(25, 35, 58, 0.05); padding: 20px;">
                              <div class="mb-3" :style="'color: ' + widget.properties.titles_color">Average Monthly Fee: <strong>{{ widget.properties.average_monthly_fee }}</strong></div>
                      ...
                      max="999"
                        ...
                        <div class="flex flex-row flex-wrap pt-3">
                          <div class="w-full px-2 md:w-1/2 lg:w-1/2">
                            <div style="background: rgba(25, 35, 58, 0.05); padding: 20px;">
                              <div class="mb-3" :style="'color: ' + widget.properties.titles_color">% of Clients that Purchase Upsell: <strong>{{ widget.properties.percentage_of_clients_upsell }}</strong></div>
                      ...
                      max="999"
                          ...
                          <div class="w-full px-2 md:w-1/2 lg:w-1/2">
                            <div style="background: rgba(25, 35, 58, 0.05); padding: 20px;">
                              <div class="mb-3" :style="'color: ' + widget.properties.titles_color">Upsell Fee: <strong>{{ widget.properties.upsell_monthly_revenue }}</strong></div>
                    ...
                    <div class="p-3">
                		<div class="flex flex-row flex-wrap">
                			<div class="dashboard-box stats-box w-full px-2 md:w-1/2 lg:w-1/2 pt-6">
                				<div style="width: 220px; margin: auto; line-height: 30px;">
									         <div style="color: #CCCCCC; margin-top: 0px;">Daily</div>

                           <div id="lr_calculated_ddr" style="color: #000000; font-size: 18px; font-weight: bold;">{{ widget.properties.calculated_ddr ? widget.properties.calculated_ddr : this.widget.properties.currency +' 367' }}</div>

                           <div style="color: #CCCCCC; margin-top: 0px;">Annually</div>

                           <div id="lr_calculated_mrr" style="color: #000000; font-size: 18px; font-weight: bold;">{{ widget.properties.calculated_mrr ? widget.properties.calculated_mrr : this.widget.properties.currency +' 11,175' }}</div>

                           <div style="color: #CCCCCC; margin-top: 0px;">Monthly</div>

                           <div id="lr_calculated_arr" style="color: #000000; font-size: 18px; font-weight: bold;">{{ widget.properties.calculated_arr ? widget.properties.calculated_arr : this.widget.properties.currency +' 134,100' }}</div>
                				</div>
                			</div>
                			...
                			<div class="dashboard-box stats-box w-full px-2 md:w-1/2 lg:w-1/2 pt-6">
                				<div style="width: 220px; margin: auto; text-align: center; margin-top: -20px;">
									...
									<div style="color: #CCCCCC; font-weight: bold; padding-top: 0px;  margin-top: -105px;">Revenue</div>
                		...
                		<div style="margin-top: 40px; font-size: 14px; padding: 6px;">
                			...
                			<div style="clear: both; border-bottom: solid 1px rgba(0, 0, 0, 0.10); padding-bottom: 18px; margin-bottom: 18px;">
                				<div style="float: left; padding-top: 12px;" :style="'color: ' + widget.properties.titles_color">
                					Number of Local Business Clients:
                				</div>
                				...
                				<div style="float: right;">
                					<input type="number"
                						v-model="widget.properties.number_of_local_business_clients"
                						@change="calculateDdrMrrArr();"
                						@keyup="calculateDdrMrrArr();"
                						style="width: 120px; padding: 10px; height: 50px; border: solid 1px #CCCCCC; border-radius: 5px; text-align: center;"
                      min="0"
                      max="999"
                					/>
                				</div>
                      ...
                      <div style="clear: both; border-bottom: solid 1px rgba(0, 0, 0, 0.10); padding-bottom: 18px; margin-bottom: 18px;">
                        <div style="float: left; padding-top: 12px;" :style="'color: ' + widget.properties.titles_color">
                          % of Clients that Purchase Upsell:
                        </div>
    	...
    	<div v-if="CalculatorStyle == 'Style4'">
    		<div class="dashboard-box">
                ...
                >
                  ...
                  <div class="flex flex-row flex-wrap" style="font-size: 16px;">
                      <div class="w-full md:w-1/3 lg:w-1/3" style="text-align: center;">
                        <span style="font-size: 16px;">Daily</span>

                        <br />
                        <strong id="lr_calculated_ddr" style="color: #2477F6; font-weight: bold;">{{ widget.properties.calculated_ddr ? widget.properties.calculated_ddr : this.widget.properties.currency +' 367' }}</strong>

                      </div>

                      <div class="w-full md:w-1/3 lg:w-1/3" style="text-align: center;">
                        <span style="font-size: 16px;">Annually</span>

                        <br />
                        <strong id="lr_calculated_mrr" style="color: #2477F6; font-weight: bold;">{{ widget.properties.calculated_arr ? widget.properties.calculated_arr : this.widget.properties.currency +' 134,100' }}</strong>
                      ...
                      <div class="w-full md:w-1/3 lg:w-1/3" style="text-align: center;">
                        ...
                        <br />
                        <strong id="lr_calculated_arr" style="color: #2477F6; font-weight: bold;">{{ widget.properties.calculated_mrr ? widget.properties.calculated_mrr : this.widget.properties.currency +' 11,175' }}</strong>
	        ...
	        <div class="flex flex-row flex-wrap" style="font-size: 16px;">
                <div class="dashboard-box stats-box w-full md:w-1/2 lg:w-1/2 pt-4 pr-2">
	                ...
	                >
	                	<div style="margin-bottom: 10px;" :style="'color: ' + widget.properties.titles_color">Number of Local Business Clients:</div>
                ...
                <div class="dashboard-box stats-box w-full md:w-1/2 lg:w-1/2 pt-4 pl-2">
	                ...
	                >
	                	<div style="margin-bottom: 10px;" :style="'color: ' + widget.properties.titles_color">Average Monthly Fee:</div>
                ...
                <div class="dashboard-box stats-box w-full md:w-1/2 lg:w-1/2 pt-4 pr-2">
                  ...
                  >
                    <div style="margin-bottom: 10px;" :style="'color: ' + widget.properties.titles_color">% of Clients that Purchase Upsell:</div>
              ...
              />
                ...
                <div class="dashboard-box stats-box w-full md:w-1/2 lg:w-1/2 pt-4 pl-2">
                  ...
                  >
                    <div style="margin-bottom: 10px;" :style="'color: ' + widget.properties.titles_color">Upsell Fee:</div>
