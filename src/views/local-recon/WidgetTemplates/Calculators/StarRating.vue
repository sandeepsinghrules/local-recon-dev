    	...
    	<div v-if="CalculatorStyle == 'Style1'">
    		<v-card>
              ...
              <div class="float-right text-center" :style="'width: 30%; height: 330px; padding-top: 55px; font-size: 24px; background-color: ' + widget.properties.result_background_color + '; color: ' + widget.properties.result_text_color + '; font-weight: bold;'">
                  ...
                  <h3 class="lr_you_need_reviews" style="line-height: 52px;">{{ widget.properties.you_need_reviews }}</h3>
                		...
                		<div class="flex flex-row flex-wrap">
                			<div class="dashboard-box stats-box w-full px-2 md:w-1/3 lg:w-1/3 pt-6">
                				<div style="width: 220px; margin: auto; text-align: center;">
									...
									<br />
									<div style="color: #CCCCCC; margin-top: -60px;">You Need</div>

									<div class="lr_you_need_reviews" style="color: #000000; font-size: 22px; font-weight: bold;">{{ widget.properties.you_need_reviews }}</div>

									<div style="color: #000000; font-weight: bold; padding-top: 50px;">More 5 Star Reviews</div>
                				</div>
                			</div>
                				...
                				<div class="flex flex-row flex-wrap">
                					<div class="w-full px-2 md:w-1/2 lg:w-1/2">
                						<div style="background: rgba(25, 35, 58, 0.05); padding: 20px;">
                							<div class="mb-3" :style="'color: ' + widget.properties.titles_color">Current Google Rating: <strong>{{ widget.properties.current_google_rating }}</strong></div>
                					...
                					<div class="w-full px-2 md:w-1/2 lg:w-1/2">
                						<div style="background: rgba(25, 35, 58, 0.05); padding: 20px;">
                							<div class="mb-3" :style="'color: ' + widget.properties.titles_color">Current number of Google reviews: <strong>{{ widget.properties.current_number_of_google_reviews }}</strong></div>
                					...
                					<div class="w-full px-2 mt-3">
                						<div style="background: rgba(25, 35, 58, 0.05); padding: 20px;">
                							<div class="mb-3" :style="'color: ' + widget.properties.titles_color">Desired Google Rating: <strong>{{ widget.properties.desired_google_rating }}</strong></div>
                		...
                		<div class="flex flex-row flex-wrap">
                			<div class="dashboard-box stats-box w-full px-2 md:w-1/2 lg:w-1/2 pt-6">
                				<div style="width: 220px; margin: auto; line-height: 50px;">
									<div style="color: #CCCCCC; margin-top: 0px;">You Need</div>

									<div class="lr_you_need_reviews" style="color: #000000; font-size: 22px; font-weight: bold;">{{ widget.properties.you_need_reviews }}</div>

									<div style="color: #000000; font-weight: bold; padding-top: 0px;">More 5 Star Reviews</div>
                				</div>
                			</div>
                			...
                			<div class="dashboard-box stats-box w-full px-2 md:w-1/2 lg:w-1/2 pt-6">
                				<div style="width: 220px; margin: auto; text-align: center; margin-top: -20px;">
									...
									<div class="lr_you_need_reviews" style="color: #000000; font-size: 22px; font-weight: bold; margin-top: -125px;">{{ widget.properties.you_need_reviews }}</div>
                			...
                			<div style="clear: both; border-bottom: solid 1px rgba(0, 0, 0, 0.10); padding-bottom: 18px; margin-bottom: 18px;">
                				...
                				<div style="float: right;">
                					<input type="number"
                						v-model="widget.properties.current_google_rating"
                						@change="widget.properties.you_need_reviews = youNeedReviews();"
                						@keyup="widget.properties.you_need_reviews = youNeedReviews();"
                						style="width: 60px; padding: 10px; height: 50px; border: solid 1px #CCCCCC; border-radius: 5px; text-align: center;"
                						min="0.1"
				                          step="0.1"
				                          max="5"
                					/>
    	...
    	<div v-if="CalculatorStyle == 'Style4'">
    		<div class="dashboard-box">
                ...
                >
					...
					<div class="lr_you_need_reviews" style="color: #2477F6; font-weight: bold;">{{ widget.properties.you_need_reviews }}</div>
	        ...
	        <div class="flex flex-row flex-wrap" style="font-size: 16px;">
                <div class="dashboard-box stats-box w-full md:w-1/2 lg:w-1/2 pt-4 pr-2">
	                ...
	                >
	                	<div style="margin-bottom: 10px;" :style="'color: ' + widget.properties.titles_color">Current Google Rating:</div>
                ...
                <div class="dashboard-box stats-box w-full md:w-1/2 lg:w-1/2 pt-4 pl-2">
	                ...
	                >
	                	<div style="margin-bottom: 10px;" :style="'color: ' + widget.properties.titles_color">Current number of Google reviews:</div>
                ...
                <div class="dashboard-box stats-box w-full pt-4">
	                ...
	                >
	                	<div style="margin-bottom: 10px;" :style="'color: ' + widget.properties.titles_color">Desired Google Rating:</div>
  ...
  export default {
    ...
    methods: {
      ...
      youNeedReviews() {
          ...
          try {
              for (var i in document.querySelectorAll(".lr_you_need_reviews")) {
              	let el = document.querySelectorAll(".lr_you_need_reviews")[i];

              	if (number_of_new_ratings > 1000)
                   el.innerHTML = "1000+";
	            else
	               el.innerHTML = number_of_new_ratings;
              }
          }
          catch (e) {}
